...
public class ValidatedCardFactory_SucessfulCreation {
    ...
    private static final CardType TYPE_1 = new CardType.Builder("Type Name").addSingleNumberPatterns("1234").validLengths(10).build();
    private static final CardType TYPE_2 = new CardType.Builder("Type Name").addSingleNumberPatterns("12345").validLengths(11).build();
    private static final CardType TYPE_3 = new CardType.Builder("Type Name").addSingleNumberPatterns("123").validLengths(10).build();
    private static final CardType TYPE_4 = new CardType.Builder("Type Name").addSingleNumberPatterns("12345").validLengths(12).build();
